...
echo -ne "\033[1;31m [2] > " && msg -azu "$(fun_trans "CAMBIAR PROTOCOLO") "
echo -ne "\033[1;37m [3] > " && msg -azu "$(fun_trans "ACTIVAR TLS") "
echo -ne "\033[1;33m [4] > " && msg -azu "$(fun_trans "CAMBIAR PUERTO V2RAY")\n$(msg -bar) "
## CONTROLER
echo -ne "\033[1;37m [5] > " && msg -azu "AGREGAR USUARIO UUID "
echo -ne "\033[1;33m [6] > " && msg -azu "ELIMINAR USUARIO UUID"
echo -ne "\033[1;34m [7] > " && msg -azu "MOSTAR USUARIOS REGISTRADOS"
echo -ne "\033[1;36m [8] > " && msg -azu "INFORMACION DE CUENTAS"
echo -ne "\033[1;37m [9] > " && msg -azu "ESTADISTICAS DE CONSUMO "
echo -ne "\033[1;33m [10] > " && msg -azu "LIMITADOR POR CONSUMO\e[91m ( BETA x PORT )"
