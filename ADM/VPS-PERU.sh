...
kalix1="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3Zwc2NyL1ZQUy9tYWluL0hFUlJBTUlFTlRBUw=="
PUTO='base64 -d'
...
clear
msg -bar2
msg -ama "     [ AYUDAR NOS HACE GRANDES \033[1;97m ❌ ELLA NO TE AMA ❌\033[1;33m ]"
msg -bar2
echo ""
...
clear
msg -bar2
msg -ama "     [ VPS ACTUALIZADO  2021-2022 \033[1;97m ❌ ALAN TECK PERU ❌\033[1;33m ]"
msg -bar2
...
echo 'echo "" '>> .bashrc                                               
echo 'echo -e "\t\033[97mPARA MOSTAR PANEL BASH ESCRIBA: sudo alan o peru "'>> .bashrc
...
echo -e "  \033[1;41m               sudo alan o peru            \033[0;37m" && msg -bar2
sleep 5
exit
}
ofus () {
...
clear
msg -bar
msg -ama "     [ actualizado \033[1;97m ❌ 2021-2022❌\033[1;33m ]"
msg -bar
msg -ama " Notify-BOT (Notificasion Remota)| VPS 962948255 "
msg -bar
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "Code de KEY Invalido!") ]]; then
   msg -bar2
   msg -verd "$(source trans -b es:${id} " Ficheros Copiados"|sed -e 's/[^a-z -]//ig'): \e[97m[\e[93mALAN TECK INSTALANDO\e[97m]"
   ...
   echo "${SCPdir}/menu" > /usr/bin/peru && chmod +x /usr/bin/peru
